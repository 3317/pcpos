...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', '管理者権限', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'マネージャー権限', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', '従業員権限', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'ゲスト権限', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', '管理者', NULL, '0', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'マネージャー', NULL, '1', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', '従業員', NULL, '2', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'ゲスト', NULL, '3', 1, NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('18', 'banknote.10000yen', 1, $FILE{/com/openbravo/pos/templates/banknote.10000yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('19', 'banknote.5000yen', 1, $FILE{/com/openbravo/pos/templates/banknote.5000yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'banknote.2000yen', 1, $FILE{/com/openbravo/pos/templates/banknote.2000yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('21', 'banknote.1000yen', 1, $FILE{/com/openbravo/pos/templates/banknote.1000yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('22', 'coin.500yen', 1, $FILE{/com/openbravo/pos/templates/coin.500yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('23', 'coin.100yen', 1, $FILE{/com/openbravo/pos/templates/coin.100yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('24', 'coin.50yen', 1, $FILE{/com/openbravo/pos/templates/coin.50yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('25', 'coin.10yen', 1, $FILE{/com/openbravo/pos/templates/coin.10yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('26', 'coin.5yen', 1, $FILE{/com/openbravo/pos/templates/coin.5yen.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('27', 'coin.1yen', 1, $FILE{/com/openbravo/pos/templates/coin.1yen.png});
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('29', 'Script.StockCurrentAdd', 0, $FILE{/com/openbravo/pos/templates/Script.StockCurrentAdd.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('30', 'Script.StockCurrentSet', 0, $FILE{/com/openbravo/pos/templates/Script.StockCurrentSet.txt});
...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('000', '標準カテゴリ');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', '消費税');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', '免税', '000', NULL, NULL, 0, 0, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', '消費税', '001', NULL, NULL, 0.05, 0, NULL);
...
INSERT INTO LOCATIONS(ID, NAME,ADDRESS) VALUES('0', '一般', NULL);
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'レストラン フロア', $FILE{/com/openbravo/pos/templates/restaurantsample.png});
